            ...
            <div>
              ...
              <div className="py-6">
                ...
                <p className="text-[15px] leading-6 text-center">
                  A herbal tea made from dried chamomile flowers, chamomile tea
                  is known for its mild and soothing properties, making it a
                  popular choice for relaxation.
                </p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div>
              ...
              <div className="py-6">
                ...
                <p className="text-[15px] leading-6 text-center">
                  A partially oxidized tea with a diverse range of flavors,
                  oolong tea falls between green and black tea, offering a
                  unique and nuanced taste.
                </p>
              </div>
            </div>
          </SwiperSlide>
            ...
            <div>
              ...
              <div className="py-6">
                ...
                <p className="text-[15px] leading-6 text-center">
                  ...
                  caffeine-free and a popular choice for those seeking a
